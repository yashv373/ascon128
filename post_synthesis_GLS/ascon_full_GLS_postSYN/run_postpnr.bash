#!/bin/bash
# EDAPlayground Post-PNR Gate-Level Simulation (GLS) Script
# Make sure "Use run.bash shell script" is checked in EDAPlayground

echo "========================================================="
echo " Downloading Post-PNR Netlist, SDF & PDK Files..."
echo "========================================================="
curl -O "https://raw.githubusercontent.com/yashv373/ascon128/main/edaplayground_gls/spi_slave_postpnr.nl.v"
curl -O "https://raw.githubusercontent.com/yashv373/ascon128/main/edaplayground_gls/spi_slave_postpnr.sdf"
...
# Link Post-PNR netlist and SDF for testbench.sv
cp spi_slave_postpnr.nl.v spi_slave.nl.v
cp spi_slave_postpnr.sdf spi_slave.sdf
...
echo "========================================================="
echo " Running Post-PNR Gate-Level Simulation..."
echo "========================================================="
./simv
