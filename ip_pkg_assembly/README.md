...
---
- What: It encapsulates the raw Verilog source code, physical layout (GDSII), constraints (SDC), and configuration files into an industry-standard reusable IP block. The included library (`Library/`) allows other developers to easily integrate the accelerator into their own System-on-Chip (SoC) designs using a drag-and-drop methodology.
- Since we wanted to make our ascon hardware accelerator as reusable by the future users in the open-source ecosystem to enable re-usability and plug and play usage of this IP in other SoC systems, this IPXACT based package enables easier SoC integration.
---
### How:
...
---
below image shows the packaged ascon_top into the test assembly ascon_soc, in the Kactus2 gui.
<img width="1591" height="984" alt="image" src="https://github.com/user-attachments/assets/1554c759-01a3-4dfb-8c24-b20947c82c72" />
